// PATCH v0.2.9 – Version Debug + Cache-Busting + Visual Display

console.log("🧩 Frontend Script Version: v0.2.9");
...
function renderDebugPanel(data) {
  ...
  if (versionTag && data.version) {
    versionTag.textContent = `Frontend: v0.2.9 / Backend: ${data.version}`;
  }
}
