...
cat << 'SIMPLIFIED_WARDROBE_SCRIPT' > update_inventory.sh
#!/bin/bash
set -e
...
SIMPLIFIED_WARDROBE_SCRIPT

chmod +x update_inventory.sh
echo "✅ Created script to add wardrobe editor with simplified inventory. Run it with: ./update_inventory.sh"
